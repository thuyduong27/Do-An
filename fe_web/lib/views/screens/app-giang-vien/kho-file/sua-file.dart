...
class SuaFile extends StatefulWidget {
  FileGuiSv data;
  Function callbackChange;
  SuaFile({Key? key, required this.callbackChange, required this.data}) : super(key: key);

  @override
  _QuanLyDNScreenState createState() => _QuanLyDNScreenState();
}

class _QuanLyDNScreenState extends State<SuaFile> {
                                    ...
                                    child: TextButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (title.text == "" || fileName == "") {
                                          ...
                                          data.status = 1;
                                          await httpPut("/api/file-gvhd-gui-sv/put/${data.id}", data.toJson(), context);
                                          showToast(
                                            context: context,
