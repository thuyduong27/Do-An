...
import 'sua-thong-bao.dart';
import 'them-thong-bao.dart';

class ThongBaoGuiSVScreen extends StatefulWidget {
  const ThongBaoGuiSVScreen({Key? key}) : super(key: key);

  @override
  _QuanLyDNScreenState createState() => _QuanLyDNScreenState();
}

class _QuanLyDNScreenState extends State<ThongBaoGuiSVScreen> {
  var page = 1;
  var rowPerPage = 10;
  var totalElements = 0;
  ...
  var currentPage = 1;
  var tableIndex = 1;
  List<ThongBaoGVHD> listData = [];
  String findGVHD = "";

  Future<List<ThongBaoGVHD>> getData(int page, String findGVHD, int idgv) async {
    ...
    var response5;
    if (findGVHD == "") {
      response5 = await httpGet("/api/thong-bao-thuc-tap/get/page?size=$rowPerPage&page=$page&filter=giaoVien.idNguoiDung:$idgv and giaoVien.idKhtt:${selectedKHTT.id}", context);
    } else {
      response5 = await httpGet("/api/thong-bao-thuc-tap/get/page?size=$rowPerPage&page=$page&filter=giaoVien.idNguoiDung:$idgv and giaoVien.idKhtt:${selectedKHTT.id} and $findGVHD", context);
    }
              ...
              ? ListView(
                  ...
                  children: [
                    TitlePage(
                        ...
                        content: 'Thông báo gửi sinh viên',
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        await Navigator.push<void>(
                                                          ...
                                                          MaterialPageRoute<void>(
                                                            builder: (BuildContext context) => ThemMoiThongBaoGuiSV(
                                                              idgv: idGv,
                                  ...
                                  children: [
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      child: DataTable(showCheckboxColumn: false, columnSpacing: 30, border: TableBorder.all(color: colorPage), columns: [
                                        ...
                                        DataColumn(label: Text('Lần sửa gần nhất', style: textDataColumn)),
                                        ...
                                        for (var i = 0; i < listData.length; i++)
                                          DataRow(
                                            cells: [
                                              ...
                                              DataCell(Text("${listData[i].title}", style: textDataRow)),
                                                      ...
                                                      child: InkWell(
                                                          onTap: () {
                                                            Navigator.push<void>(
                                                              context,
                                                              MaterialPageRoute<void>(
                                                                builder: (BuildContext context) => SuaThongBaoGuiSV(
                                                                  edit: false,
                                                                  data: listData[i],
                                                                  callbackChange: (value) {
                                                                    setState(() {
                                                            ...
                                                            await showDialog(
                                                                ...
                                                                builder: (BuildContext context) => AlertDialog(
                                                                      ...
                                                                      actions: [
                                                                        ...
                                                                        ElevatedButton(
                                                                          onPressed: () async {
                                                                            var response = await httpDelete("/api/thong-bao-thuc-tap/del/${listData[i].id}", context);
