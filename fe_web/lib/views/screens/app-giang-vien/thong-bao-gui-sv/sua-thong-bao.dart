...
class SuaThongBaoGuiSV extends StatefulWidget {
  bool edit;
  ThongBaoGVHD data;
  Function? callbackChange;
  SuaThongBaoGuiSV({Key? key, this.callbackChange, required this.data, required this.edit}) : super(key: key);

  @override
  _QuanLyDNScreenState createState() => _QuanLyDNScreenState();
}

class _QuanLyDNScreenState extends State<SuaThongBaoGuiSV> {
          ...
          child: ListView(
            ...
            children: [
              TitlePage(
                ...
                content: (widget.edit)? 'Cập nhật':'Thông tin chi tiết',
              ),
              Container(
                                          ...
                                          child: TextButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (title.text == "" || content.text == "") {
                                                ...
                                                data.status = 1;
                                                await httpPut("/api/thong-bao-thuc-tap/put/*{data.id}", data.toJson(), context);
                                                showToast(
                                                  context: context,
